...
const voices = [
  { quote: "I'm not just selling tomatoes anymore. I'm telling their story.", name: "Ramesh, 34", role: "Onion & tomato farmer · Nashik", initials: "R" },
  { quote: "I finally know who grew the dal on my plate. That changes everything.", name: "Anita, 29", role: "Home cook · Pune", initials: "A" },
  { quote: "The PM-Kisan update reached me before the patwari did.", name: "Sukhdev, 58", role: "Wheat farmer · Hisar", initials: "S" },
];
...
function AuthPage() {
  ...
  return (
    <div className="h-screen w-full grid grid-cols-[1.1fr_1fr]">
     {/* left pannel */}
      <div className="relative hidden md:flex flex-col bg-[#1A4331] p-10 overflow-hidden ">
        {/* Background image */}
         <img
  ...
  <div className="relative z-10 flex flex-col justify-between h-full text-white">
    ...
    {/* Brand */}
    <h2 className="text-2xl font-bold">KissanConnect</h2>
...
<div className="grid grid-cols-2 gap-2 mt-6">
  {pillars.map((p) => (
    <div key={p.label} className="bg-white/10 border border-white/10 rounded-xl p-3">
      ...
      {/* RIGHT PANEL */}
<div className="flex flex-col justify-center px-14 bg-[#F7F5F0] h-screen overflow-y-auto">
  <div className="w-full max-w-sm mx-auto">
    ...
    <div className="flex items-center justify-between mb-8">
      <div className="inline-flex items-center gap-2 bg-[#1A4331]/10 border border-[#1A4331]/20 rounded-full px-3 py-1">
        <span className="text-[11px] uppercase tracking-widest font-semibold text-[#1A4331]">
    ...
    {/* Heading */}
    <h2
      className="text-4xl font-bold text-[#1A4331] mb-2 leading-tight"
      style={{ fontFamily: "'Playfair Display', serif" }}
    >
      {mode === 'login' ? 'Welcome back to the aangan.' : 'Pull up a charpai.'}
    </h2>
    <p className="text-sm text-[#758079] mb-6">
      {mode === 'login'
    ...
    {/* Switch mode */}
    <p className="mt-4 text-sm text-[#4B5550] text-center">
    ...
    {/* Stats */}
    <div className="mt-6 pt-5 border-t border-[#E5E2D9] grid grid-cols-3 gap-3">
      {[
